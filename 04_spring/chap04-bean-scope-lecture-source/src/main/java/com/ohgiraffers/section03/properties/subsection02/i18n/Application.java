...
public class Application {
    public static void main(String[] args) {
        ...
        /* 설명.
         *  i18n 소프트웨어의 국체화(Internarionalization에서 첫 글자인 i와 마지말 글자인 n 사이에 알파벳 개수가 18개)란?
         *   소프트웨어 국제화를 하기 위해서는 처리해야할 작업이 많이 있다.
         *   1. 언어, 지역별 번역
         *   2. OS/Platform별 인코딩
         *   3. 문자열 치환 방법
         ...
         *
         * 설명
         *  우리가 다뤄본 예제는 그 중 1번 에서만 해당하는 다국어 메세지 처리만 확인
        * */
