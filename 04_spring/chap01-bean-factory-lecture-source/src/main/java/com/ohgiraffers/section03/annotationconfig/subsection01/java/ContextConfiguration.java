...
/* 설명. 설정용 클래스도 baen으로 관리되며 이름(bean의 id)을 부여할 수 있다. */
@Configuration("configurationSection03")    // 이름을 설정하지 못하면 자동으로 설정된 beanName(contextConfiguration)

/* 설명. 1. 단순히 범위 지정만으로 @Component계열의 어노테이션을 모두 bean으로 관리하는 경우 */
...
@ComponentScan(basePackages = "com.ohgiraffers",  // {"com.ohgiraffers","com"} -> 여러가지 패키지 적용가능
