...
public class Application1 {
    public static void main(String[] args) {
        ...
        /* 설명. 키 값은 중복되면 이후 put 되는 키와 벨류가 덮어씌운다(주의!) */
        hmap.put(12, "puple banana");
        System.out.println(hmap.get(12));

        /* 설명. 벨류는 중복되어도 상관 없다. */
        hmap.put(77, "puple banana");
        System.out.println(hmap);

        System.out.println("Map이 지닌 entry의 수: " + hmap.size());

        System.out.println("77번 키와 관련된 entry 삭제: " + hmap.remove(77));  // 지워지면서 반환도 가능
        System.out.println("삭제 후 entry의 수: " + hmap.size());

        /* 필기. Map을 반복하여 각 entry들(키와 벨류)을 활용해보자 */
        ...
        while(iter.hasNext()) {
            ...
            System.out.println("key값: " + key + ", value 값: " + hmap2.get(key));
        }
        System.out.println();
