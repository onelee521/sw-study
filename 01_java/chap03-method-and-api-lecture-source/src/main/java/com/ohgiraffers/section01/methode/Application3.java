...
public class Application3 {
    ...
    public static void main(String[] args) {
        ...
        int global = 20;                                        // 지역변수, 지역변수가 전역변수보다 우선순위가 더 높다
        System.out.println("global = " + global);               // 출력: global = 20
        System.out.println("global = " + Application3.global);  // 출력: global = 10 /클래스명.변수명을 하면 클래스변수를 호출할 수 있다.
        ...
        * */
        ...
        app3.testMethod(19);
//        app3.testMethod(15, 16);               // 인자의 순서, 타입, 개수가 전부 맞아야 함
