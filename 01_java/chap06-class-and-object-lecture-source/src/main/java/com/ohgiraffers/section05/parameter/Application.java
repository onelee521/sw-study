...
public class Application {
    ...
    * */
    public static void main(String[] args) {
        ...
        pt.testPrimitiveTypeParameter(num);             // call by value: 리터럴 값에 의한 호출, 깊은 복사
        ...
        pt.testPrimitiveTypeArrayParameter(iArr);       // call by reference: 참조 값에 의한 호출, 얕은 복사
...
//        r1.calArea();
//        r1.calRound();
        pt.testCalssTypeArrayParameter(r1);
