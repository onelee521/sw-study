...
public class Application {
    ...
    * */
    public static void main(String[] args) {
        ...
        /* 설명.
         *  회원정보를 관리하기 위해 회원의 여러 정보(아이디, 비밀번호, 이름, 나이, 성별, 취미)를
         *  취급하여 관리하려고 한다.
        ...
        * */
         ...
         *  3. 메소드의 반환형으로 회원이라는 개념을 반환할 수 없다.(메소드의 반환형은 하나여야하기 때문)
        * */
        ...
        /* 설명. 또한 메소드릐 반환형으로 한 번에 회원 정보를 반환할 수 있고 반환 받은 곳에서 반환된 객체에 접근도 가능하다. */
