...
public class Application {
    ...
    public static void main(String[] args) {
        ...
        * */
        ...
        StaticFiledTest stf1 = new StaticFiledTest();

        /* 설명. 현재 두 필드가 가지고 있는 값 확인 */
        System.out.println("non-static field: " + stf1.getNonStaticCount());
        System.out.println("static field: " + StaticFiledTest.getStaticCount());

        /* 설명. 각 필드 값들을 하나씩 증가 */
        stf1.increaseNonStaticCount();
        StaticFiledTest.increaseStaticCount();
        ...
        /* 설명. 새로운 객체 생성 */
        StaticFiledTest stf2 = new StaticFiledTest();
