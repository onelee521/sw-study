...
//        StringBuilder sb2 = new StringBuilder("javamariaDB");       // 문자열 크기 + 16byte
        StringBuffer sb2 = new StringBuffer("javamariaDB");       // 문자열 크기 + 16byte, 버퍼도 메소드 같음
...
//        System.out.println("deleteCharAt(): " + sb2.deleteCharAt(0));      // avmariaDB
