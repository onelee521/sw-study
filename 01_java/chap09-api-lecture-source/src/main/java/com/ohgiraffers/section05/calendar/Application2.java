...
public class Application2 {
    public static void main(String[] args) {
        ...
        * */
        ...
        /* 설명. Calender 자료형은 생성자를 통해 객체를 생성할 수 없다. */
        Calendar cal = Calendar.getInstance();
        System.out.println("cal = " + cal);

        Calendar cal2 = new GregorianCalendar();        // 윤년에 대한 처리가 더 잘 되어있음
        System.out.println("cal2 = " + cal2);

        int year = 1999;
        int month = 4;                          // 입력하고자 하는 월 - 1(월이 0 ~ 11로 설정)
        int dayOfMonth = 21;
        int hour = 21;
        int min = 3;
        int second = 0;
        ...
        System.out.println("btrthDay = " + birthDay);

        /* 설명. GragorianCalendar 객체가 가진 값 확인 */
        System.out.println("태어난 해 = " + birthDay.get(1));
        System.out.println("태어난 해 = " + birthDay.get(Calendar.YEAR));
        System.out.println("태어난 월 = " + (birthDay.get(2) + 1));         // get()메소드로 반환 받은 값에 +1릏 해줘야 우리가 생각하는 월의 개념이 된다.
        System.out.println("태어난 월 = " + (birthDay.get(Calendar.MONTH) + 1));         // get()메소드로 반환 받은 값에 +1릏 해줘야 우리가 생각하는 월의 개념이 된다.
        ...
        System.out.println("내 생일은 " + day + "요일이다.");
