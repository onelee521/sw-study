...
public class Application1 {
    public static void main(String[] args) {
        ...
        * */
        ...
        System.out.println("indaexOf('a'): " + indexOf.indexOf('a'));
        System.out.println("indaexOf('z'): " + indexOf.indexOf('z'));

        /* 필기.
         *  lastindexOf(): 문자열에서 특정 문자를 뒤에서부터 탐색하여 처음 일치하는 인덱스 위치를 정수형으로 반환한다.
         *                 (반환하지 않으면 -1 반환)
         * */

        System.out.println("lastIndaexOf('a'): " + indexOf.lastIndexOf('a'));
        System.out.println("laseIndaexOf('z'): " + indexOf.lastIndexOf('z'));
        ...
        * */
        ...
        /* 필기.
         *  lenth(): 문자열의 길이를 정수형으로 반환한다.
        * */
        System.out.println("lenth(): " + javamariaDB.length());
        System.out.println("빈 문자열의 길이: " + "".length());

        /* 필기.
         *  isEmpty(): 문자열의 길이가 0이면 true를 반환, 아니면 false를 반환(null과 다르다.)
        * */
        System.out.println("idEmpty(): " + "".isEmpty());
        System.out.println("idEmpty(): " + "abc".isEmpty());
    }
}
