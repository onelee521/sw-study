...
public class Application1 {
    public static void main(String[] args) {
        ...
        /* 설명. 기본자료형을 Wrpper클래스 자료형으로 변환할 수 있다(boxing) */
        Integer boxingInt = (Integer)20;
        Integer boxingInt2 = Integer.valueOf(intValue);

        /* 설명. Wrapper클래스 자료형을 기본자료형으로 변환할 수 있다.(unboxing) */
        ...
        System.out.println(" == 비교: " + (integerTest == integerTest2));             //true
//        System.out.println(" equlas() 비교: " + integerTest.equals(integerTest2));  //true
    ...
    public static void anythingmethod(Object obj){  // 10 -> Integer(오토박싱) -> Object(다형성)
        System.out.println("obj: " + obj);          // Object의 toString()이 아닌 Integer의 toString()이 실행 됨(동적바인딩)
    }
}
