...
public class Application2 {
    public static void main(String[] args){
        ...
        System.out.println(123 / 10);
        System.out.println(123 % 10);                               //설명. modulus 연산자(mod): 체수로 나눈 나머지
        ...
        System.out.println(1.23 / 10.0);
        System.out.println(1.23 % 1.0);                             // 설명. 실수는 정확하지 않고 근사값 0.22999999999999998

        /* 필기. 정수와 실수의 연산 결과는 실수가 나온다.(정수를 실수로 바꿔 연산해 준다. 다른 타입끼리 연산X) */
        ...
        System.out.println("hello" + "world");      // 설명. 문자열간의 연산은 덧셈(이어붙이기)만 가능하다.
...
//        System.out.println("hello" % "world");
        ...
        /* 설명. 이항연산자들의 묶음에서 좌측에서부터 이항씩 연산하면 아래의 코드 결과를 이해할 수 있다.*/
        System.out.println(123 + 3 + "helloworld" + 123 + 3); // 결과: "126helloworld1233"

        /* 설명. 문자열 뒤에 숫자를 활용한 연산을 쓰게 되면 소괄호(())를 써서 우선순위를 높이고 연산해 주어야 한다. */
        System.out.println("합계: " + 123 + 456);         // 결과: "합계: 123456"
        System.out.println("합계: " + (123 + 456));       // 결과: "합계: 579"


        /* 목차. 4. 논리 값의 연산 */
        /* 설명. 대부분의 연산이 적용되지 않고 논리와 문자열의 연산만 가능하다. */
//        System.out.println(true + 1); // 설명. 컴파일 에러
