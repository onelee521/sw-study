...
public class Application1 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("num = " + num); // 필기. soutv
         ...
         *   2. 한 번 저장해둔 값을 재사용하기 위한 목적(변수를 이용하여 코드를 작성하면, 값을 변경할 때도 보다 간편하게 변경 가능)
         *   3. 시간에 따라 변경되는 값을 저장하고 시용할 목적(변하는 값을 저장하기 위한 공간)
        * */
        ...
        /* 목차. 3. 시간에 따라 변경되는 값을 저장하고 시용할 목적*/
        System.out.println("============== 변수에 저장한 값 변경 테스트 ==================");
        int sum = 0;

        sum = sum + 10;                                 // 기존에 0이 담겨있던 변수에 10을 덮어슴(변수는 하나의 리터럴 값만 저장 가능)
        ...
        /* 설명. 동일한 하나의 변수를 어느 시점에 출력하느냐에 따라 출력 결과는 달라진다.(변수명은 같지만 들어있는 값은 달라짐) */
