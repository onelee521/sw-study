...
public class Application3 {
    ...
    public static void main(String[] args) {
         ...
         *   또한, 규칙에 맞는 올바른 변수명을 짓는 것이 좋은 프로그래밍을 하는 첫단계이다.
        * */
...
//        int for = 2;
        ...
        int gGe = 20;           // 위에 만든 age와 다른 변수로 취급
...
//        int #harp = 11;
        ...
        int skdjskladjksajdklalkllk;

        /* 목차. 2-2. 변수명이 합성어로 이루어진 경우 첫단어는 소문자, 두 번째 시작 단어는 대문자로 시작한다. */
        int maxAge = 50;                // camel case(낙타봉 표기법)
        int minAge = 10;
