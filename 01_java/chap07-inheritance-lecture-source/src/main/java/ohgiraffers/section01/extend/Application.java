...
public class Application {
    ...
    public static void main(String[] args) {
        ...
        /* 필기.
         *  상속은 부모의 멤버를 물려받아 재사용성에 유리하게 만들기위한 객체지향의 특징이자 문법이다.
         *  하지만 단순히 물려받아 재상용하는 개념보다 부모클래스의 개념을 확장(extends)하는데 더 의의가 있으며
         ...
         *   1-2. 부모클래스만 수정해도 자식 클래스 전체에 적용된다.(유지보수 측면)
         ...
         *
         * 필기.
         *  장점과 단점을 고려했을 떼, 상속은 오용의 가능성이 있기 때문에
         *  IS-A 관계로 구분되는 경우에만 잘 고려하여 적용해야한다,
         *  (IS-A 관계 vs HAS-A 관계)
        * */
        Car car = new Car();
...
//        fireCar firCar =  new Car();      // 생성자 상속이 안되므로 불가능
