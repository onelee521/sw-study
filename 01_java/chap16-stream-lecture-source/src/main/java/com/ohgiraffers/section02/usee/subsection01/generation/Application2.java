package com.ohgiraffers.section02.usee.subsection01.generation;
...
public class Application2 {
    public static void main(String[] args) {
        ...
        * */
        ...
        longStream.forEach(value -> System.out.print(value + " "));   // 내 맘대로 커스텀해서 Consumer 타입으로 출력
//        longStream.forEach(System.out::println);                        // println이 출력하는 방식 그대로
        System.out.println();

        /* 필기.
         *  Wrapper 클래스의 자료형의 스트림이 필요한 경우 boxing도 가능하다.
         *  doubles(갯수): 난수를 활용한 DoubleStream을 갯수만큼 생성하여 반환한다.
         *  boxed(): 기본 타입 스트림인 XXXStrem을 박싱하여 Wrapper 타입의 Stream<XXX>를 변환한다.
        * */
