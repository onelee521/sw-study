...
public class Application5 {
    ...
    public static void main(String[] args) {
        ...
        int randomCardNumberIndex;      // 0 ~ 12

        randomShapeIndex = new Random().nextInt(4);
        randomCardNumberIndex = new Random().nextInt(13);

//        System.out.println("당신이 뽑은 카드는 " + shape[0] + cardNumber[0] + " 카드 입니다.");
