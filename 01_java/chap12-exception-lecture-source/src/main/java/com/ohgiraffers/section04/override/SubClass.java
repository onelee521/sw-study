...
public class SubClass extends SuperClass{
    ...
    /* 필기.
     *  메소드를 오버라이딩 하기 위해서는 부모 메소드애서 발생하는 예외와 같거나 하위 타입은 가능하다.
     *  아예 예외가 발생하지 않더라도 오버라이딩에는 문제가 있다.
     *  반면, 부모의 메소드보다 더 상위 타입의 에외를 발생키기는 오버라이딩 메소드는 컴파일에러가 발생한다.
...
//
//    }
    /* 설명. 부모의 메소드와 달리 예외를 발생시키지 않음(pass) */
//    @Override
//    public void method() {
//
//    }
