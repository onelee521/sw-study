...
public class Applicaiton1 {
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            /* 설명.
             *  catch구문으로 처리할 예외가 발생하는 부분을 try 구문으로 묶을 수 있다.
             *  범위는 너무 크지 않게 적당히 지정할 것(관련 있는 것만)
            * */
...
//            System.out.println(e.getClass());
            System.out.println("예외 발생 메세지 확인: " + e.getMessage());

            /* 설명. try 구문에서 발생한 예외 타입을 받아 jvm이 처리해 주는 방식으로 처리할 수 있다. */
            e.printStackTrace();        // JVM이 처리해주는 방식

            /* 설명. 내가 원하는 시점에 프로그램을 종료할 수 있다.(추천하지 않는 방법) */
//            System.exit(0);
        }
