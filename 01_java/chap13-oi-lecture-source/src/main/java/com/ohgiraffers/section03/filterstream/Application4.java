...
public class Application4 {
    public static void main(String[] args) {
        ...
        memArr[1] = new MemberDTO("user02", "pass02", "유관순", "uuu4@gmail.com", 18, '여');
        memArr[2] = new MemberDTO("user03", "pass03", "이순신", "lee333@gmail.com", 41, '남');
        ...
        * */
        ...
        /* 설명. 입력받아 새로운 MemberDTO[]에 저장된 회원을 확인 */
