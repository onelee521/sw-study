...
public class Application {
    ...
    public static void main(String[] args) {
        ...
        while(true) {
            ...
            System.out.println("1. 모든 회원 정보 찾아보기");
            ...
            switch (input){
                case 1: mm.selectAllMembers();
                    break;
                case 2: mm.selectMember(chooseMemberNo());      // chooseMemberNo() 먼저 실행 후 반환된 값을 selectMember()에서 사용
                    break;
    ...
    /* 설명. 사용자로부터 회원번호를 제외한 정보를 입력 받아(회원가입 정보) Member타입으로 반환하는 매소드(파싱 및 가공처리) */
    private static Member signUp() {
        ...
        /* 필기.
         *  회원으로부터 회원가입을 위한 정보를 입력받아 Member 타입 객체 하나로 가공 처리할 때 방법이 두가지가 있다.
