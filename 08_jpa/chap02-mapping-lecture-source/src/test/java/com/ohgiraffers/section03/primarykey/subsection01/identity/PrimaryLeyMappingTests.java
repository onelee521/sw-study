...
public class PrimaryLeyMappingTests {
...
//        member.setMemberNo(1);        // auto_increment
...
//        member2.setMemberNo(2);
        ...
        member2.setEmail("yuyu@gamil.com");
...
//        System.out.println("selectedMember = " + selectedMember);
        ...
        String jpql = "SELECT A.memberNo FROM member_section03_subsection01 A"; // 별칭을 달아야하고 memberNo는 필드의 이름
